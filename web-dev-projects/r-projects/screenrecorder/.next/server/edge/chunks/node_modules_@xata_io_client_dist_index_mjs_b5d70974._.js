(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/node_modules_@xata_io_client_dist_index_mjs_b5d70974._.js", {

"[project]/node_modules/@xata.io/client/dist/index.mjs [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "XataApiClient": (()=>XataApiClient),
    "XataApiPlugin": (()=>XataApiPlugin),
    "XataError": (()=>XataError),
    "XataFile": (()=>XataFile),
    "XataPlugin": (()=>XataPlugin),
    "acceptWorkspaceMemberInvite": (()=>acceptWorkspaceMemberInvite),
    "adaptAllTables": (()=>adaptAllTables),
    "adaptTable": (()=>adaptTable),
    "addGitBranchesEntry": (()=>addGitBranchesEntry),
    "addTableColumn": (()=>addTableColumn),
    "aggregateTable": (()=>aggregateTable),
    "applyBranchSchemaEdit": (()=>applyBranchSchemaEdit),
    "applyMigration": (()=>applyMigration),
    "askTable": (()=>askTable),
    "askTableSession": (()=>askTableSession),
    "branchTransaction": (()=>branchTransaction),
    "buildClient": (()=>buildClient),
    "buildPreviewBranchName": (()=>buildPreviewBranchName),
    "buildProviderString": (()=>buildProviderString),
    "bulkInsertTableRecords": (()=>bulkInsertTableRecords),
    "cancelWorkspaceMemberInvite": (()=>cancelWorkspaceMemberInvite),
    "compareBranchSchemas": (()=>compareBranchSchemas),
    "compareBranchWithUserSchema": (()=>compareBranchWithUserSchema),
    "compareMigrationRequest": (()=>compareMigrationRequest),
    ...
    "deleteDatabaseGithubSettings": (()=>deleteDatabaseGithubSettings),
    "deleteFile": (()=>deleteFile),
    "deleteFileItem": (()=>deleteFileItem),
    "deleteOAuthAccessToken": (()=>deleteOAuthAccessToken),
    "deleteRecord": (()=>deleteRecord),
    "deleteTable": (()=>deleteTable),
    "deleteUser": (()=>deleteUser),
    "deleteUserAPIKey": (()=>deleteUserAPIKey),
    "deleteUserOAuthClient": (()=>deleteUserOAuthClient),
    "deleteWorkspace": (()=>deleteWorkspace),
    "deserialize": (()=>deserialize),
    "dropClusterExtension": (()=>dropClusterExtension),
    "endsWith": (()=>endsWith),
    "equals": (()=>equals),
    "executeBranchMigrationPlan": (()=>executeBranchMigrationPlan),
    "exists": (()=>exists),
    ...
    "getBranchMigrationHistory": (()=>getBranchMigrationHistory),
    "getBranchMigrationJobStatus": (()=>getBranchMigrationJobStatus),
    "getBranchMigrationPlan": (()=>getBranchMigrationPlan),
    "getBranchMoveStatus": (()=>getBranchMoveStatus),
    "getBranchSchemaHistory": (()=>getBranchSchemaHistory),
    "getBranchStats": (()=>getBranchStats),
    "getCluster": (()=>getCluster),
    "getClusterMetrics": (()=>getClusterMetrics),
    "getColumn": (()=>getColumn),
    "getDatabaseGithubSettings": (()=>getDatabaseGithubSettings),
    "getDatabaseList": (()=>getDatabaseList),
    "getDatabaseMetadata": (()=>getDatabaseMetadata),
    "getDatabaseSettings": (()=>getDatabaseSettings),
    "getDeployPreviewBranch": (()=>getDeployPreviewBranch),
    "getFile": (()=>getFile),
    "getFileItem": (()=>getFileItem),
    "getGitBranchesMapping": (()=>getGitBranchesMapping),
    "getHostUrl": (()=>getHostUrl),
    "getMigrationHistory": (()=>getMigrationHistory),
    "getMigrationJobStatus": (()=>getMigrationJobStatus),
    "getMigrationJobs": (()=>getMigrationJobs),
    "getMigrationRequest": (()=>getMigrationRequest),
    "getMigrationRequestIsMerged": (()=>getMigrationRequestIsMerged),
    "getRecord": (()=>getRecord),
    "getSchema": (()=>getSchema),
    ...
    "getUserOAuthAccessTokens": (()=>getUserOAuthAccessTokens),
    "getUserOAuthClients": (()=>getUserOAuthClients),
    "getWorkspace": (()=>getWorkspace),
    "getWorkspaceMembersList": (()=>getWorkspaceMembersList),
    "getWorkspaceSettings": (()=>getWorkspaceSettings),
    "getWorkspacesList": (()=>getWorkspacesList),
    ...
    "insertRecordWithID": (()=>insertRecordWithID),
    "installClusterExtension": (()=>installClusterExtension),
    "inviteWorkspaceMember": (()=>inviteWorkspaceMember),
    "is": (()=>is),
    "isCursorPaginationOptions": (()=>isCursorPaginationOptions),
    "isHostProviderAlias": (()=>isHostProviderAlias),
    "isHostProviderBuilder": (()=>isHostProviderBuilder),
    "isIdentifiable": (()=>isIdentifiable),
    "isNot": (()=>isNot),
    "isValidExpandedColumn": (()=>isValidExpandedColumn),
    "isValidSelectableColumns": (()=>isValidSelectableColumns),
    "le": (()=>le),
    "lessEquals": (()=>lessEquals),
    "lessThan": (()=>lessThan),
    "lessThanEquals": (()=>lessThanEquals),
    "listClusterBranches": (()=>listClusterBranches),
    "listClusterExtensions": (()=>listClusterExtensions),
    "listClusters": (()=>listClusters),
    "listMigrationRequestsCommits": (()=>listMigrationRequestsCommits),
    "listRegions": (()=>listRegions),
    "lt": (()=>lt),
    "lte": (()=>lte),
    "mergeMigrationRequest": (()=>mergeMigrationRequest),
    "moveBranch": (()=>moveBranch),
    "notExists": (()=>notExists),
    "operationsByTag": (()=>operationsByTag),
    "parseProviderString": (()=>parseProviderString),
    "parseWorkspacesUrlParts": (()=>parseWorkspacesUrlParts),
    "pattern": (()=>pattern),
    "previewBranchSchemaEdit": (()=>previewBranchSchemaEdit),
    "pushBranchMigrations": (()=>pushBranchMigrations),
    "putFile": (()=>putFile),
    "putFileItem": (()=>putFileItem),
    "queryMigrationRequests": (()=>queryMigrationRequests),
    "queryTable": (()=>queryTable),
    "removeGitBranchesEntry": (()=>removeGitBranchesEntry),
    "removeWorkspaceMember": (()=>removeWorkspaceMember),
    "renameDatabase": (()=>renameDatabase),
    "resendWorkspaceMemberInvite": (()=>resendWorkspaceMemberInvite),
    ...
    "sqlBatchQuery": (()=>sqlBatchQuery),
    "sqlQuery": (()=>sqlQuery),
    "startMigration": (()=>startMigration),
    "startsWith": (()=>startsWith),
    "summarizeTable": (()=>summarizeTable),
    "transformImage": (()=>transformImage),
    "updateBranchMetadata": (()=>updateBranchMetadata),
    "updateBranchSchema": (()=>updateBranchSchema),
    "updateCluster": (()=>updateCluster),
    "updateColumn": (()=>updateColumn),
    "updateDatabaseGithubSettings": (()=>updateDatabaseGithubSettings),
    "updateDatabaseMetadata": (()=>updateDatabaseMetadata),
    "updateDatabaseSettings": (()=>updateDatabaseSettings),
    "updateMigrationRequest": (()=>updateMigrationRequest),
    "updateOAuthAccessToken": (()=>updateOAuthAccessToken),
    "updateRecordWithID": (()=>updateRecordWithID),
    "updateTable": (()=>updateTable),
    "updateUser": (()=>updateUser),
    "updateWorkspace": (()=>updateWorkspace),
    "updateWorkspaceMemberInvite": (()=>updateWorkspaceMemberInvite),
    "updateWorkspaceMemberRole": (()=>updateWorkspaceMemberRole),
    "updateWorkspaceSettings": (()=>updateWorkspaceSettings),
    "upsertRecordWithID": (()=>upsertRecordWithID),
    "vectorSearchTable": (()=>vectorSearchTable)
});
   ...
   */ lastIndexOf(value, byteOffset, encoding) {
    ...
    _bidirectionalIndexOf(buffer, val, byteOffset, encoding, dir) {
        ...
        if (Buffer.isBuffer(val)) {
            ...
            return Buffer._arrayIndexOf(buffer, Buffer.from([
                val
...
function fetchEventSource(input, { signal: inputSignal, headers: inputHeaders, onopen: inputOnOpen, onmessage, onclose, onerror, fetch: inputFetch, ...rest }) {
...
const resolveUrl = (url, queryParams = {}, pathParams = {})=>{
    ...
    const cleanPathParams = Object.entries(pathParams).reduce((acc, [key, value])=>{
        return {
            ...acc,
            [key]: encodeURIComponent(String(value ?? "")).replace("%3A", ":")
        };
    }, {});
    return url.replace(/\{\w*\}/g, (key)=>cleanPathParams[key.slice(1, -1)]) + queryString;
};
function buildBaseUrl({ method, endpoint, path, workspacesApiUrl, apiUrl, pathParams = {} }) {
...
async function fetch$1({ url: path, method, body, headers: customHeaders, pathParams, queryParams, fetch: fetch2, apiKey, endpoint, apiUrl, workspacesApiUrl, trace, signal, clientID, sessionID, clientName, xataAgentExtra, fetchOptions = {}, rawResponse = false }) {
    ...
    return await trace(`${method.toUpperCase()} ${path}`, async ({ setAttributes })=>{
        ...
        const headers = compactObject({
            ...
            "X-Features": compact([
                "feat-internal-field-rename-api=1",
                customHeaders?.["X-Features"]
            ]).join(" "),
            ...customHeaders,
            ...hostHeader(fullUrl),
        ...
        [TraceAttributes.HTTP_METHOD]: method.toUpperCase(),
        [TraceAttributes.HTTP_ROUTE]: path
    });
}
function fetchSSERequest({ url: path, method, body, headers: customHeaders, pathParams, queryParams, fetch: fetch2, apiKey, endpoint, apiUrl, workspacesApiUrl, onMessage, onError, onClose, signal, clientID, sessionID, clientName, xataAgentExtra }) {
    const baseUrl = buildBaseUrl({
        method,
        endpoint,
        path,
...
const dataPlaneFetch = async (options)=>fetch$1({
        ...options,
        endpoint: "dataPlane"
    });
...
const updateDatabaseSettings = (variables, signal)=>dataPlaneFetch({
        url: "/dbs/{dbName}/settings",
        method: "patch",
        ...variables,
        signal
    });
const createBranchAsync = (variables, signal)=>dataPlaneFetch({
        url: "/db/{dbBranchName}/async",
        method: "put",
        ...variables,
        signal
    });
...
const createBranch = (variables, signal)=>dataPlaneFetch({
        url: "/db/{dbBranchName}",
        method: "put",
        ...variables,
        signal
...
const getBranchMoveStatus = (variables, signal)=>dataPlaneFetch({
...
const getGitBranchesMapping = (variables, signal)=>dataPlaneFetch({
        url: "/dbs/{dbName}/gitBranches",
        method: "get",
        ...variables,
        signal
    });
const addGitBranchesEntry = (variables, signal)=>dataPlaneFetch({
        url: "/dbs/{dbName}/gitBranches",
        method: "post",
        ...variables,
        signal
...
const createMigrationRequest = (variables, signal)=>dataPlaneFetch({
...
const controlPlaneFetch = async (options)=>fetch$1({
        ...options,
        endpoint: "controlPlane"
    });
const getAuthorizationCode = (variables, signal)=>controlPlaneFetch({
        url: "/oauth/authorize",
        method: "get",
        ...variables,
        signal
    });
const grantAuthorizationCode = (variables, signal)=>controlPlaneFetch({
        url: "/oauth/authorize",
        method: "post",
        ...variables,
        signal
...
class XataFile {
    ...
    transform(...options) {
        return {
            ...
            metadataUrl: transformImage(this.url, ...options, {
                format: "json"
            }),
            metadataSignedUrl: transformImage(this.signedUrl, ...options, {
                format: "json"
            })
        };
    }
...
class Page {
   ...
   */ async nextPage(size, offset) {
        return __privateGet$4(this, _query).getPaginated({
            pagination: {
                size,
                offset,
...
const _PageRecordArray = class _PageRecordArray extends Array {
    constructor(...args){
        ...
        __privateSet$3(this, _page, isObject(args[0]?.meta) ? args[0] : {
            meta: {
                page: {
                    cursor: "",
                    more: false
...
const _Query = class _Query {
   ...
   */ any(...queries) {
        ...
        return new _Query(__privateGet$3(this, _repository), __privateGet$3(this, _table$1), {
            filter: {
                $any
            }
   ...
   */ none(...queries) {
    ...
    filter(a, b) {
        if (arguments.length === 1) {
            ...
            const $all = compact([
                __privateGet$3(this, _data).filter?.$all
            ].flat().concat(constraints));
            return new _Query(__privateGet$3(this, _repository), __privateGet$3(this, _table$1), {
                filter: {
                    $all
                }
            ...
            const constraints = isDefined(a) && isDefined(b) ? [
                {
                    [a]: __privateMethod$3(this, _Query_instances, cleanFilterConstraint_fn).call(this, a, b)
                }
            ] : void 0;
            const $all = compact([
                __privateGet$3(this, _data).filter?.$all
    ...
    sort(column, direction = "asc") {
        const originalSort = [
            __privateGet$3(this, _data).sort ?? []
        ].flat();
        const sort = [
            ...originalSort,
            {
   ...
   */ async *[Symbol.asyncIterator]() {
        for await (const [record] of this.getIterator({
            batchSize: 1
        })){
            yield record;
        }
    ...
    async *getIterator(options = {}) {
        ...
        let page = await this.getPaginated({
            ...options,
            pagination: {
                size: batchSize,
                offset: 0
...
function buildSortFilter(filter) {
    if (isSortFilterString(filter)) {
        ...
        return {
            [filter.column]: filter.direction ?? "asc"
        };
    } else {
...
class RestRepository extends Query {
    constructor(options){
        super(null, {
            name: options.table,
            schema: options.schemaTables?.find((table)=>table.name === options.table)
        }, {});
        ...
        __privateSet$1(this, _getFetchProps, ()=>({
    ...
    async create(a, b, c, d) {
        return __privateGet$2(this, _trace).call(this, "create", async ()=>{
            ...
            if (Array.isArray(a)) {
                ...
                const ids = await __privateMethod$2(this, _RestRepository_instances, insertRecords_fn).call(this, a, {
                    ifVersion,
                    createOnly: true
                });
            ...
            if (isString(a) && isObject(b)) {
                ...
                return await __privateMethod$2(this, _RestRepository_instances, insertRecordWithId_fn).call(this, a, b, columns, {
                    createOnly: true,
                    ifVersion
                });
            }
            if (isObject(a) && isString(a.xata_id)) {
                ...
                return await __privateMethod$2(this, _RestRepository_instances, insertRecordWithId_fn).call(this, a.xata_id, {
                    ...a,
                    xata_id: void 0
                }, columns, {
                    createOnly: true,
    ...
    async read(a, b) {
        return __privateGet$2(this, _trace).call(this, "read", async ()=>{
            ...
            if (Array.isArray(a)) {
                ...
                const finalObjects = await this.getAll({
                    filter: {
                        xata_id: {
                            $any: compact(ids)
                        }
    ...
    async update(a, b, c, d) {
        return __privateGet$2(this, _trace).call(this, "update", async ()=>{
            ...
            try {
                if (isString(a) && isObject(b)) {
                    const columns = isValidSelectableColumns(c) ? c : void 0;
                    return await __privateMethod$2(this, _RestRepository_instances, updateRecordWithID_fn).call(this, a, b, columns, {
                        ifVersion
                    });
                }
                if (isObject(a) && isString(a.xata_id)) {
                    const columns = isValidSelectableColumns(b) ? b : void 0;
                    return await __privateMethod$2(this, _RestRepository_instances, updateRecordWithID_fn).call(this, a.xata_id, {
                        ...a,
                        xata_id: void 0
                    }, columns, {
                        ifVersion
    ...
    async createOrUpdate(a, b, c, d) {
        return __privateGet$2(this, _trace).call(this, "createOrUpdate", async ()=>{
            ...
            if (isString(a) && isObject(b)) {
                if (a === "") throw new Error("The id can't be empty");
                const columns = isValidSelectableColumns(c) ? c : void 0;
                return await __privateMethod$2(this, _RestRepository_instances, upsertRecordWithID_fn).call(this, a, b, columns, {
                    ifVersion
                });
            }
            if (isObject(a) && isString(a.xata_id)) {
                if (a.xata_id === "") throw new Error("The id can't be empty");
                const columns = isValidSelectableColumns(c) ? c : void 0;
                return await __privateMethod$2(this, _RestRepository_instances, upsertRecordWithID_fn).call(this, a.xata_id, {
                    ...a,
                    xata_id: void 0
                }, columns, {
                    ifVersion
    ...
    async query(query) {
        return __privateGet$2(this, _trace).call(this, "query", async ()=>{
            ...
            const schemaTables = await __privateMethod$2(this, _RestRepository_instances, getSchemaTables_fn).call(this);
            const records = objects.map((record)=>initObject(__privateGet$2(this, _db), schemaTables, __privateGet$2(this, _table), record, data.columns ?? [
                    "*"
                ]));
        ...
        return __privateGet$2(this, _trace).call(this, "summarize", async ()=>{
            ...
            const result = await summarizeTable({
                ...
                body: {
                    ...
                    columns: data.columns,
                    consistency: data.consistency,
                    page: data.pagination?.size !== void 0 ? {
            ...
            return {
                ...result,
                summaries: result.summaries.map((summary)=>initObject(__privateGet$2(this, _db), schemaTables, __privateGet$2(this, _table), summary, data.columns ?? []))
            };
        });
    }
    ask(question, options) {
        const questionParam = options?.sessionId ? {
            message: question
        } : {
            question
        };
...
insertRecords_fn = async function(objects, { createOnly, ifVersion }) {
    const operations = await promiseMap(objects, async (object)=>{
        ...
        return {
            insert: {
                table: __privateGet$2(this, _table),
                record,
                createOnly,
                ifVersion
            }
...
deleteRecords_fn = async function(recordIds) {
    const chunkedOperations = chunk(compact(recordIds).map((id)=>({
            delete: {
                table: __privateGet$2(this, _table),
                id
            }
...
const initObject = (db, schemaTables, table, object, selectedColumns)=>{
    ...
    record.update = function(data2, b, c) {
        ...
        return db[table].update(record["xata_id"], data2, columns2, {
            ifVersion
        });
    };
    record.replace = function(data2, b, c) {
        ...
        const ifVersion = parseIfVersion(b, c);
        return db[table].createOrReplace(record["xata_id"], data2, columns2, {
            ifVersion
        });
    };
...
const includesNone = (value)=>({
        $includesNone: value
    });
const includesAny = (value)=>({
        $includesAny: value
    });
        ...
        const db = new Proxy({}, {
            get: (_target, table)=>{
                ...
                if (__privateGet$1(this, _tables)[table] === void 0) {
                    __privateGet$1(this, _tables)[table] = new RestRepository({
                        db,
                        pluginOptions,
                        table,
            ...
            all: async (query, options = {})=>{
                ...
                return {
                    ...
                    records: records.map((record)=>{
                        ...
                        return {
                            table,
                            record: initObject(this.db, pluginOptions.tables, table, record, [
                                "*"
                            ])
                        };
                    })
...
function prepareParams(param1, param2) {
    if (isString(param1)) {
        return {
            statement: param1,
            params: param2?.map((value)=>prepareValue(value))
        };
    }
    ...
    if (isObject(param1)) {
        ...
        return {
            statement,
            params: params?.map((value)=>prepareValue(value)),
            consistency,
            responseType
        };
    }
    ...
    build(pluginOptions) {
        ...
        sqlFunction.batch = async (query)=>{
            const { results } = await sqlBatchQuery({
                ...
                body: {
                    statements: query.statements.map(({ statement, params })=>({
                            statement,
                            params
                        })),
...
const buildClient = (plugins)=>{
    ...
    return _a = class {
        ...
        const isBrowser = "undefined" !== "undefined" && typeof Deno === "undefined";
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        }
        const fetch1 = getFetchImplementation(options?.fetch);
    ...
    }, getFetchProps_fn = function({ fetch: fetch1, apiKey, databaseURL, branch, trace, clientID, clientName, xataAgentExtra }) {
        return {
            fetch: fetch1,
            apiKey,
            apiUrl: "",
            ...
            case "vercel":
                {
                    ...
                    return buildPreviewBranchName({
                        org: vercelGitRepoOwner,
...
//# sourceMappingURL=node_modules_%40xata_io_client_dist_index_mjs_b5d70974._.js.map