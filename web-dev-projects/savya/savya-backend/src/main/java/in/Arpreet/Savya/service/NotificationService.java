...
public class NotificationService {
    ...
    public void sendDailyExpenseSummary(){
        ...
        List<ProfileEntity> profiles = profileRepository.findAll();
        for(ProfileEntity profile : profiles){
            List<ExpenseDTO> todaysExpenses = expenseService.getExpensesFromUserOnDate(profile.getId(), LocalDate.now(ZoneId.of("Asia/Kolkata")));
            if(!todaysExpenses.isEmpty()){
                ...
                table.append("</table>");
                String body = "Hi " + profile.getFullName() + ",<br><br> Here is summary of expenses for today: <br/><br/>"+table+"<br/><br/> Best regards, <br/>Savya Team";
