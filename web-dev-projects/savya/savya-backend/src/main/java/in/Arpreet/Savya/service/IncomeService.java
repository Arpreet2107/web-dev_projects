...
public class IncomeService {
    ...
    //Retrieves all incomes for the current month or by startDate/endDate
    ...
    //Get the latest 5 incomes for the current user
