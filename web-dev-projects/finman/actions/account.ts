...
// Type for decimal serialization
type SerializedObject = {
  [key: string]: any;
};

const serializeDecimal = (obj: any): SerializedObject => {
  const serialized: SerializedObject = { ...obj };
...
// Fetch account details with transactions
