import {
  ...
  const PREVIEW_DATA: { monthlyReport: EmailTemplateProps; budgetAlert: EmailTemplateProps } = {
    monthlyReport: {
      userName: "John Doe",
      type: "monthly-report",
      data: {
          ...
          <Body style={styles.body}>
            <Container style={styles.container}>
              ...
              <Text style={styles.text}>
                Here’s your financial summary for {reportData?.month}:
              </Text>
        ...
        <Html>
          ...
          <Body style={styles.body}>
            <Container style={styles.container}>
              ...
              <Text style={styles.text}>Hello {userName},</Text>
              <Text style={styles.text}>
                You’ve used {alertData?.percentageUsed.toFixed(1)}% of your monthly budget.
              </Text>
              <Section style={styles.statsContainer}>
                <div style={styles.stat}>
