...
import AshwinSantiago from "@/src/assets/images/ashwin-santiago.jpg";
import AlecWhitten from "@/src/assets/images/alec-whitten.jpg";
import ReneWells from "@/src/assets/images/rene-wells.jpg";
import MollieHall from "@/src/assets/images/mollie-hall.jpg";
        ...
        <SectionBorder borderTop>
          <SectionContent>
            <LayoutGroup>
              <motion.div
                layout
                className="border-gradient rounded-3xl px-6 md:px-10 lg:px-16 py-16 lg:py-24 relative flex flex-col md:flex-row gap-12 md:mx-10 lg:mx-0"
              >
                {/* Quote Icon */}
                <FontAwesomeIcon
                  icon={faQuoteLeft}
