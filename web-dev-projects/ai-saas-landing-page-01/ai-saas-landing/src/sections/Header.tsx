...
export const Header = () => {
  ...
  return (
      ...
      <div className="container">
        <div className="h-18 lg:h-20 flex justify-between items-center">
          <div className="flex gap-4 items-center">
            <Logo />
            <div className="font-semibold text-2xl">spherial.ai</div>
          </div>
    ...
    {isMobileNavOpen && (
      <div className="fixed top-18 left-0 bottom-0 right-8 bg-gray-950 z-30 overflow-hidden">
